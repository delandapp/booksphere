import 'package:booksphere/app/data/constans/validation.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      padding: EdgeInsets.symmetric(
          vertical: heightFullBody * 0.04, horizontal: widthFullBody * 0.07),
      child: Form(
          ...
          children: [
            ...
            Padding(
              padding: EdgeInsets.only(
                  top: heightFullBody * 0.02,
                  bottom: heightFullBody * 0.05),
              child: SizedBox(
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Padding(
                          padding:
                              EdgeInsets.only(top: heightFullBody * 0.015),
                          child: SizedBox(
                      ...
                      children: [
                        Obx(() => Checkbox(
                              shape: const RoundedRectangleBorder(
                                  side:
                                      BorderSide(color: Color(0xff09142E)),
                                  borderRadius:
